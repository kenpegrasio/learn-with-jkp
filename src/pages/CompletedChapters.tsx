  ...
  useEffect(() => {
    const fetchCompleted = async () => {
      ...
      try {
        ...
        let ls: Chapter[] = [];
        for (const chapter_id of res.data.completed_chapters) {
  ...
  return (
    <Layout>
      <div className="w-[80%] sm:w-[60%] mx-auto py-12 px-6">
        <h1 className="text-4xl font-bold mb-4">Completed Chapters</h1>
        <p className="text-lg text-gray-600 mb-8">
          This is your collection of completed chapters.
        </p>
